...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("sd1", "Std Dev:", min = 0.1, max = 20, value = 5, step = 0.1),
      ...
      sliderInput("sd2", "Std Dev:", min = 0.1, max = 20, value = 5, step = 0.1),
      ...
      sliderInput("sd3", "Std Dev:", min = 0.1, max = 20, value = 5, step = 0.1),
